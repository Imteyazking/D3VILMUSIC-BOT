...
from D3vil.modules.play import generate_cover
from D3vil.modules.play import arq
from D3vil.modules.play import cb_admin_check
from D3vil.modules.play import transcode
from D3vil.modules.play import convert_seconds
from D3vil.modules.play import time_to_seconds
from D3vil.modules.play import changeImageSize
from D3vil.config import BOT_NAME as bn
from D3vil.config import DURATION_LIMIT
from D3vil.config import que
from D3vil.function.admins import admins as a
from D3vil.helpers.admins import get_administrators
from D3vil.helpers.channelmusic import get_chat_id
from D3vil.helpers.decorators import authorized_users_only
from D3vil.helpers.filters import command, other_filters
from D3vil.helpers.gets import get_file_name
from D3vil.services.callsmusic import callsmusic, queues
from D3vil.services.callsmusic.callsmusic import client as USER
from D3vil.services.converter.converter import convert
from D3vil.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @D3VIL_MUSIC_BOT to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
